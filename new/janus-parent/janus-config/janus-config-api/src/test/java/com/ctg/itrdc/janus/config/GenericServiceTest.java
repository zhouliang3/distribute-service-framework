...
public class GenericServiceTest {
    ...
    public void testGenericServiceException() {
        ...
        service.setProtocol(new ProtocolConfig("janus", 29581));
        ...
        try {
            ...
            reference.setUrl("janus://127.0.0.1:29581?generic=true");
    ...
    public void testGenericReferenceException() {
        ...
        try {
            ...
            reference.setApplication(new ApplicationConfig("generic-consumer"));
            reference.setInterface(DemoService.class);
            reference.setUrl("janus://127.0.0.1:29581?scope=remote");
            reference.setGeneric(true);
            GenericService genericService = reference.get();
            try {
                List<Map<String, Object>> users = new ArrayList<Map<String, Object>>();
                Map<String, Object> user = new HashMap<String, Object>();
                user.put("class", "com.ctg.itrdc.janus.config.api.User");
    ...
    public void testGenericImplementationWithBeanSerialization() throws Exception {
        ...
        try {
            ...
            ref.setUrl("janus://127.0.0.1:29581?scope=remote&generic=bean");
