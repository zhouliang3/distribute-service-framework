...
public class ZookeeperRegistryTest {
    ...
    String            service     = "com.ctg.itrdc.janus.test.injvmServie";
    ...
    /**
     * Test method for {@link com.ctg.itrdc.janus.registry.support.injvm.InjvmRegistry#register(java.util.Map)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.ctg.itrdc.janus.registry.support.injvm.InjvmRegistry#subscribe(java.util.Map, com.ctg.itrdc.janus.registry.support.NotifyListener)}
     * .
     */
    @Test
    public void testSubscribe() {
        ...
        registry.subscribe(service, new URL("janus", NetUtils.getLocalHost(), 0, StringUtils.parseQueryString(subscribearg)), new NotifyListener() {
