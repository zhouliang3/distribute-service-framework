...
import com.ctg.itrdc.janus.monitor.support.MonitorFilter;
...
public class MonitorFilterTest {
    ...
    private final Invoker<MonitorService> serviceInvoker = new Invoker<MonitorService>() {
        ...
        public URL getUrl() {
            try {
                return URL.valueOf("janus://" + NetUtils.getLocalHost() + ":20880?" + Constants.APPLICATION_KEY + "=abc&" + Constants.SIDE_KEY + "=" + Constants.CONSUMER_SIDE + "&" + Constants.MONITOR_KEY + "=" + URLEncoder.encode("janus://" + NetUtils.getLocalHost() + ":7070", "UTF-8"));
