...
/**
 * We don't support propertyInjector here since the resource impl should be singleton in janus
 *
 * @author lishen
 */
public class JanusResourceFactory implements ResourceFactory {
...
//    private String context = null;
    ...
    public JanusResourceFactory(Object resourceInstance, Class scannableClass) {
