...
/**
 * janus protocol lazy connect test
 * @author chao.liuc
 *
 */
public class JanusLazyConnectTest {
    ...
    public void testSticky1(){
        URL url = URL.valueOf("janus://127.0.0.1:9090/hi");
        ProtocolUtils.refer(IDemoService.class, url);
    }
    
    @Test
    public void testSticky2(){
        URL url = URL.valueOf("janus://127.0.0.1:9090/hi?"+Constants.LAZY_CONNECT_KEY+"=true");
        ProtocolUtils.refer(IDemoService.class, url);
    }
    ...
    public void testSticky4() {
        ...
        URL url = URL.valueOf("janus://127.0.0.1:"+port+"/hi?"+Constants.LAZY_CONNECT_KEY+"=true");
