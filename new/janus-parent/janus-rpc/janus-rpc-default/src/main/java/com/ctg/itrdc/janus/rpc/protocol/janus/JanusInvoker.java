...
import com.ctg.itrdc.janus.remoting.TimeoutException;
...
import com.ctg.itrdc.janus.rpc.protocol.AbstractInvoker;
 ...
 * @author chao.liuc
 */
public class JanusInvoker<T> extends AbstractInvoker<T> {
    ...
    public JanusInvoker(Class<T> serviceType, URL url, ExchangeClient[] clients){
        this(serviceType, url, clients, null);
    }
    
    public JanusInvoker(Class<T> serviceType, URL url, ExchangeClient[] clients, Set<Invoker<?>> invokers){
