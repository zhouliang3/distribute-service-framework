 ...
 */
package com.ctg.itrdc.janus.rpc.proxy.wrapper;
        ...
        if (GenericService.class != invoker.getInterface()) {
            ...
            if (ConfigUtils.isNotEmpty(stub)) {
                ...
                try {
                    ...
                    LOGGER.error("Failed to create stub implemention class " + stub + " in consumer " + NetUtils.getLocalHost() + " use janus version " + Version.getVersion() + ", cause: " + t.getMessage(), t);
                    // ignore
                }
            }
        }
