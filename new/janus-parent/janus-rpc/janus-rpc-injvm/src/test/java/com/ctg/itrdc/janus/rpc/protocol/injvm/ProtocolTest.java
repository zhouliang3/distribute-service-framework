 ...
 */
package com.ctg.itrdc.janus.rpc.protocol.injvm;
...
public class ProtocolTest {
    ...
    URL url = URL.valueOf("injvm://localhost:0/com.ctg.itrdc.janus.rpc.support.IEcho?interface=com.ctg.itrdc.janus.rpc.support.IEcho");
    ...
    public void test_destroyWontCloseAllProtocol() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("of interface com.ctg.itrdc.janus.rpc.Protocol is not adaptive method!"));
        }
