 ...
 */
package om.ctg.itrdc.janus.rpc.protocol.rmi;
...
public class RmiProtocolTest
{
    ...
    */
	...
	{
		DemoService service = new DemoServiceImpl();
		RpcUtils.export("demo://127.0.0.1:9030/com.ctg.itrdc.janus.rpc.TestService",DemoService.class,service);
		RpcUtils.export("janus://127.0.0.1:9031/TestService",DemoService.class,service);
		RpcUtils.export("rmi://127.0.0.1:9032/com.ctg.itrdc.janus.rpc.TestService",DemoService.class,service);
		RpcUtils.export("rmi://127.0.0.1:9033/com.ctg.itrdc.janus.rpc.TestService",DemoService.class,service);

		service = RpcUtils.createProxy(DemoService.class,
				new String[]{
					"demo://127.0.0.1:9030/com.ctg.itrdc.janus.rpc.TestService?weight=20",
					"janus://127.0.0.1:9031/TestService?weight=20",
					"rmi://127.0.0.1:9032/com.ctg.itrdc.janus.rpc.TestService",
				});
		assertEquals(service.getSize(null), -1);
		assertEquals(service.getSize(new String[]{"","",""}), 3);
	...
	{
		DemoService service = new DemoServiceImpl();
		protocol.export(proxy.createInvoker("janus://127.0.0.1:9040/TestService", DemoService.class, service);
		protocol.export(proxy.createInvoker("janus://127.0.0.1:9041/TestService", DemoService.class, service);
		protocol.export(proxy.createInvoker("rmi://127.0.0.1:9042/com.ctg.itrdc.janus.rpc.TestService", DemoService.class, service);
		protocol.export(proxy.createInvoker("rmi://127.0.0.1:9043/com.ctg.itrdc.janus.rpc.TestService", DemoService.class, service);

		RpcInvokerGroup group = Proxies.createInvoker(DemoService.class, new String[]{
			"janus://127.0.0.1:9040/TestService",
			"janus://127.0.0.1:9041/TestService",
			"rmi://127.0.0.1:9042/com.ctg.itrdc.janus.rpc.TestService",
			"rmi://127.0.0.1:9043/com.ctg.itrdc.janus.rpc.TestService",
		});
