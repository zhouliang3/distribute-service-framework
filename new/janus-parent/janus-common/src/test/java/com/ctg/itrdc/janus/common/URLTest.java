...
public class URLTest {
	...
	public void testWrong() throws Exception{
		URL url = URL.valueOf("abcde");
		assertEquals(url.getHost(), "abcde");
	...
	public void test_valueOf_noProtocol() throws Exception {
		...
		url = URL
				.valueOf("admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan");
		assertNull(url.getProtocol());
	...
	public void test_valueOf_WithProtocolHost() throws Exception {
		URL url = URL.valueOf("janus://10.20.130.230");
		...
		url = URL.valueOf("janus://10.20.130.230:20880/context/path");
		assertEquals("janus", url.getProtocol());
		assertNull(url.getUsername());
		assertNull(url.getPassword());
		assertEquals("10.20.130.230", url.getHost());
		...
		url = URL.valueOf("janus://admin:hello1234@10.20.130.230:20880");
		assertEquals("janus", url.getProtocol());
		assertEquals("admin", url.getUsername());
		assertEquals("hello1234", url.getPassword());
		assertEquals("10.20.130.230", url.getHost());
		...
		url = URL.valueOf("janus://admin:hello1234@10.20.130.230:20880?version=1.0.0");
		assertEquals("janus", url.getProtocol());
		assertEquals("admin", url.getUsername());
		assertEquals("hello1234", url.getPassword());
		assertEquals("10.20.130.230", url.getHost());
		...
		url = URL
				.valueOf("janus://admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan");
		assertEquals("janus", url.getProtocol());
		assertEquals("admin", url.getUsername());
		assertEquals("hello1234", url.getPassword());
		assertEquals("10.20.130.230", url.getHost());
		...
		url = URL
				.valueOf("janus://admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan&noValue");
		assertEquals("janus", url.getProtocol());
		assertEquals("admin", url.getUsername());
		assertEquals("hello1234", url.getPassword());
		assertEquals("10.20.130.230", url.getHost());
	...
	// TODO 不希望空格？ 详见： JANUS-502 URL类对特殊字符处理统一约定
	@Test
	...
	public void test_equals() throws Exception {
		...
		URL url2 = new URL("janus", "admin", "hello1234", "10.20.130.230", 20880, "context/path",
				params);
	...
	public void test_toString() throws Exception {
		...
		assertThat(
				url1.toString(),
				anyOf(equalTo("janus://10.20.130.230:20880/context/path?version=1.0.0&application=morgan"),
						equalTo("janus://10.20.130.230:20880/context/path?application=morgan&version=1.0.0")));
	}
	...
	public void test_toFullString() throws Exception {
		...
		assertThat(
				url1.toFullString(),
				anyOf(equalTo("janus://admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan"),
						equalTo("janus://admin:hello1234@10.20.130.230:20880/context/path?application=morgan&version=1.0.0")));
	}
	...
	public void test_removeParameters() throws Exception {
		URL url = URL
				.valueOf("janus://admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan&k1=v1&k2=v2");
	...
	public void test_addParameter() throws Exception {
		URL url = URL
				.valueOf("janus://admin:hello1234@10.20.130.230:20880/context/path?application=morgan");
	...
	public void test_addParameter_sameKv() throws Exception {
		URL url = URL
				.valueOf("janus://admin:hello1234@10.20.130.230:20880/context/path?application=morgan&k1=v1");
	...
	public void test_addParameters() throws Exception {
		...
		url = URL
				.valueOf("janus://admin:hello1234@10.20.130.230:20880/context/path?application=morgan");
		url = url.addParametersIfAbsent(CollectionUtils.toStringMap("k1", "v1", "k2", "v2",
				"application", "xxx"));
	...
	public void test_addParameters_SameKv() throws Exception {
		...
		{
			URL url = URL
					.valueOf("janus://admin:hello1234@10.20.130.230:20880/context/path?application=morgan&k1=v1&k2=v2");
	...
	public void test_Anyhost() throws Exception {
		URL url = URL.valueOf("janus://0.0.0.0:20880");
	...
	public void test_Localhost() throws Exception {
		URL url = URL.valueOf("janus://127.0.0.1:20880");
		assertEquals("127.0.0.1", url.getHost());
		assertTrue(url.isLocalHost());

		url = URL.valueOf("janus://127.0.1.1:20880");
		assertEquals("127.0.1.1", url.getHost());
		assertTrue(url.isLocalHost());

		url = URL.valueOf("janus://localhost:20880");
