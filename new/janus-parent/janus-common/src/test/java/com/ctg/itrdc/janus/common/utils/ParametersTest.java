...
{
	final String ServiceName = "com.ctg.itrdc.janus.rpc.service.GenericService";
	...
	public void testMap2Parameters() throws Exception
	{
		...
		map.put("name", "com.ctg.itrdc.janus.rpc.service.GenericService");
	...
	{
		String qs = "name=com.ctg.itrdc.janus.rpc.service.GenericService&version=1.0.15&lb=lcr";
