...
public class Constants {
    ...
    public static final String JANUS_PROPERTIES_KEY = "janus.properties.file";

    public static final String DEFAULT_JANUS_PROPERTIES = "janus.properties";
    ...
    public static final String DEFAULT_DIRECTORY = "janus";

    public static final String DEFAULT_LOADBALANCE = "random";

    public static final String DEFAULT_PROTOCOL = "janus";
    ...
    public static final String DEFAULT_REMOTING_CODEC = "janus";
    ...
    public static final String DEFAULT_THREAD_NAME = "janus";
    ...
    public static final int DEFAULT_ALIVE = 60 * 1000;//iundo test 测试时将此值调大 默认60 * 1000

    public static final int DEFAULT_CONNECTIONS = 0;

    public static final int DEFAULT_ACCEPTS = 0;

    public static final int DEFAULT_IDLE_TIMEOUT = 600 * 1000;//iundo test 测试时将此值调大 默认600 * 1000

    public static final int DEFAULT_HEARTBEAT = 60 * 1000;

    public static final int DEFAULT_TIMEOUT = 1000;//iundo test 测试时将此值调大 默认1000

    public static final int DEFAULT_CONNECT_TIMEOUT = 3000;//iundo test 测试时将此值调大  默认3000

    public static final int DEFAULT_REGISTRY_CONNECT_TIMEOUT = 5000;//iundo test 测试时将此值调大  默认5000
    ...
    public static final String DEFAULT_REGISTRY = "janus";
    ...
    public static final String DEFAULT_PROMPT = "janus>";
    ...
    public static final String JANUS_VERSION_KEY = "janus";
    ...
    @Deprecated
    public static final String SHUTDOWN_WAIT_SECONDS_KEY = "janus.service.shutdown.wait.seconds";

    public static final String SHUTDOWN_WAIT_KEY = "janus.service.shutdown.wait";
    ...
    public static final String STUB_EVENT_KEY = "janus.stub.event";

    public static final boolean DEFAULT_STUB_EVENT = false;

    public static final String STUB_EVENT_METHODS_KEY = "janus.stub.event.methods";
