...
public class URLTest {
	...
	public void test_equals() throws Exception {
		...
		URL url2 = new URL("dubbo", "admin", "hello1234", "10.20.130.230", 20880, "context/path",
				params);
	...
	public void test_addParameter() throws Exception {
		URL url = URL
				.valueOf("dubbo://admin:hello1234@10.20.130.230:20880/context/path?application=morgan");
	...
	public void test_addParameter_sameKv() throws Exception {
		URL url = URL
				.valueOf("dubbo://admin:hello1234@10.20.130.230:20880/context/path?application=morgan&k1=v1");
