 ...
 */
package com.ctg.itrdc.janus.common.extensionloader;
...
import com.ctg.itrdc.janus.common.extensionloader.activate.ActivateExt1;
import com.ctg.itrdc.janus.common.extensionloader.activate.impl.ActivateExt1Impl1;
import com.ctg.itrdc.janus.common.extensionloader.activate.impl.GroupActivateExtImpl;
import com.ctg.itrdc.janus.common.extensionloader.activate.impl.OrderActivateExtImpl1;
import com.ctg.itrdc.janus.common.extensionloader.activate.impl.OrderActivateExtImpl2;
import com.ctg.itrdc.janus.common.extensionloader.activate.impl.ValueActivateExtImpl;
import com.ctg.itrdc.janus.common.extensionloader.ext1.impl.SimpleExtImpl1;
import com.ctg.itrdc.janus.common.extensionloader.ext6_wrap.WrappedExt;
import com.ctg.itrdc.janus.common.extensionloader.ext7.InitErrorExt;
import com.ctg.itrdc.janus.common.extensionloader.ext8_add.AddExt1;
import com.ctg.itrdc.janus.common.extensionloader.ext8_add.AddExt2;
import com.ctg.itrdc.janus.common.extensionloader.ext8_add.AddExt3;
import com.ctg.itrdc.janus.common.extensionloader.ext8_add.AddExt4;
import com.ctg.itrdc.janus.common.extensionloader.ext8_add.impl.*;
...
import com.ctg.itrdc.janus.common.extensionloader.ext1.impl.SimpleExtImpl2;
import com.ctg.itrdc.janus.common.extensionloader.ext2.Ext2;
import com.ctg.itrdc.janus.common.extensionloader.ext6_wrap.impl.Ext5Wrapper1;
import com.ctg.itrdc.janus.common.extensionloader.ext6_wrap.impl.Ext5Wrapper2;
...
public class ExtensionLoaderTest {
    ...
    public void test_getExtensionLoader_NotInterface() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(),
                    containsString("Extension type(class com.ctg.itrdc.janus.common.extensionloader.ExtensionLoaderTest) is not interface"));
        }
    }
    ...
    public void test_getExtensionLoader_NotSpiAnnotation() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(),
                    allOf(containsString("com.ctg.itrdc.janus.common.extensionloader.NoSpiExt"),
    ...
    public void test_getExtension_ExceptionNoExtension() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(), containsString("No such extension com.ctg.itrdc.janus.common.extensionloader.ext1.SimpleExt by name XXX"));
        }
    }
    ...
    public void test_getExtension_ExceptionNoExtension_WrapperNotAffactName() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(), containsString("No such extension com.ctg.itrdc.janus.common.extensionloader.ext6_wrap.WrappedExt by name XXX"));
        }
    }
    ...
    public void test_AddExtension() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(), containsString("No such extension com.ctg.itrdc.janus.common.extensionloader.ext8_add.AddExt1 by name Manual"));
        }
    ...
    public void test_AddExtension_ExceptionWhenExistedExtension() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Extension name impl1 already existed(Extension interface com.ctg.itrdc.janus.common.extensionloader.ext8_add.AddExt1)!"));
        }
    }
    ...
    public void test_AddExtension_Adaptive_ExceptionWhenExistedAdaptive() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Adaptive Extension already existed(Extension interface com.ctg.itrdc.janus.common.extensionloader.ext8_add.AddExt1)!"));
        }
    }
    ...
    public void test_replaceExtension_ExceptionWhenNotExistedExtension() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Extension name NotExistedExtension not existed(Extension interface com.ctg.itrdc.janus.common.extensionloader.ext8_add.AddExt1)"));
        }
    }
    ...
    public void test_replaceExtension_Adaptive_ExceptionWhenNotExistedExtension() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Adaptive Extension not existed(Extension interface com.ctg.itrdc.janus.common.extensionloader.ext8_add.AddExt4)"));
        }
    }
    ...
    public void test_InitError() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Failed to load extension class(interface: interface com.ctg.itrdc.janus.common.extensionloader.ext7.InitErrorExt"));
    ...
    public void testLoadActivateExtension() throws Exception {
        // test default
        //inote modify META-INF/services/com.ctg.itrdc.janus.common.extensionloader.activate.ActivateExt1

        URL url = URL.valueOf("test://localhost/test");
        ExtensionLoader<ActivateExt1> extensionLoader = ExtensionLoader.getExtensionLoader(ActivateExt1.class);
        List<ActivateExt1> list = extensionLoader.getActivateExtension(url, new String[]{}, "default_group");
        Assert.assertEquals(1, list.size());
        Assert.assertTrue(list.get(0).getClass() == ActivateExt1Impl1.class);

        // test group
        url = url.addParameter(Constants.GROUP_KEY, "group1");
        list = extensionLoader.getActivateExtension(url, new String[]{}, "group1");
        Assert.assertEquals(1, list.size());
        ...
        list = extensionLoader.getActivateExtension(url, new String[]{}, "order");
