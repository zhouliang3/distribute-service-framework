 ...
 *
 */
public class JanusInvokerAvilableTest {
    private static JanusProtocol protocol = JanusProtocol.getDubboProtocol();
    ...
    public void test_Normal_available(){
        URL url = URL.valueOf("janus://127.0.0.1:20883/hi");
        ProtocolUtils.export(new DemoServiceImpl(), IDemoService.class, url);
        
        JanusInvoker<?> invoker = (JanusInvoker<?>)protocol.refer(IDemoService.class, url);
    ...
    public void test_NoInvokers() throws Exception{
        URL url = URL.valueOf("janus://127.0.0.1:20883/hi?connections=1");
        ProtocolUtils.export(new DemoServiceImpl(), IDemoService.class, url);
    ...
    public void test_Lazy_ChannelReadOnly() throws Exception{
        URL url = URL.valueOf("janus://127.0.0.1:20883/hi?lazy=true&connections=1");
        ProtocolUtils.export(new DemoServiceImpl(), IDemoService.class, url);
    ...
    private ExchangeClient[] getClients(JanusInvoker<?> invoker) throws Exception{
        Field field = JanusInvoker.class.getDeclaredField("clients");
