...
public class PortTelnetHandlerTest {
    ...
    public void before() {
        ...
        EasyMock.expect(mockInvoker.getUrl()).andReturn(URL.valueOf("janus://127.0.0.1:20887/demo")).anyTimes();
    ...
    public void testListClient() throws Exception {
        ExchangeClient client1 = Exchangers.connect("janus://127.0.0.1:20887/demo");
        ExchangeClient client2 = Exchangers.connect("janus://127.0.0.1:20887/demo");
        Thread.sleep(5000);
    ...
    public void testListDetail() throws RemotingException {
        ...
        assertEquals("janus://127.0.0.1:20887", result);
    }
