...
//        deploymentInfo.setDeploymentName("janus-rest");
...
//            deployment.getRegistry().addResourceFactory(new JanusResourceFactory(resourceInstance, resourceDef));
//        } else {
//            deployment.getRegistry().addResourceFactory(new JanusResourceFactory(resourceInstance, resourceDef), contextPath);
//        }
//    }
//
