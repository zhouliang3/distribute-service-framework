...
public class RpcContextFilter implements ContainerRequestFilter, ClientRequestFilter {
    ...
    private static final String JANUS_ATTACHMENT_HEADER = "janus-Attachments";
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        String headers = requestContext.getHeaderString(JANUS_ATTACHMENT_HEADER);
        if (headers != null) {
    ...
    public void filter(ClientRequestContext requestContext) throws IOException {
        ...
        for (Map.Entry<String, String> entry : RpcContext.getContext().getAttachments().entrySet()) {
            ...
            requestContext.getHeaders().add(JANUS_ATTACHMENT_HEADER, attachments.toString());
        }
    }
}
