...
import com.ctg.itrdc.janus.rpc.cluster.router.MockInvoker;
...
public class ConditionRouterTest {
	...
	private URL SCRIPT_URL = URL
			.valueOf("condition://0.0.0.0/com.foo.BarService");
	...
	@Test
	public void testRoute_Multi() {
		Router router = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = 1.3," + NetUtils.getLocalHost()
						+ " => "));
		List<Invoker<String>> invokers = new ArrayList<Invoker<String>>();
		invokers.add(new MockInvoker<String>());
		invokers.add(new MockInvoker<String>());
	...
	public void testRoute_ReturnAll() {
		...
		List<Invoker<String>> invokers = new ArrayList<Invoker<String>>();
		/**
		 * iundo 因此Invoker没有传入URL参数，导致测试用例报错，故注释掉
		 * 	invokers.add(new MockInvoker<String>());
		 	invokers.add(new MockInvoker<String>());
		 	invokers.add(new MockInvoker<String>());
		 */
		Invoker<String> invoker1 = new MockInvoker<String>(
				URL.valueOf("janus://10.20.3.3:20880/com.foo.BarService"));
		Invoker<String> invoker2 = new MockInvoker<String>(
				URL.valueOf("janus://" + NetUtils.getLocalHost()
	...
	public void testRoute_False_HostFilter() {
		Router router = new ConditionRouterFactory()
				.getRouter(getRouteUrl("true => " + " host = "
						+ NetUtils.getLocalHost()));
		List<Invoker<String>> invokers = new ArrayList<Invoker<String>>();
		Invoker<String> invoker1 = new MockInvoker<String>(
				URL.valueOf("janus://10.20.3.3:20880/com.foo.BarService"));
	...
	public void testRoute_Force() {
		Router router = new ConditionRouterFactory().getRouter(getRouteUrl(
				"host = " + NetUtils.getLocalHost() + " => "
						+ " host = 1.2.3.4").addParameter(Constants.FORCE_KEY,
				String.valueOf(true)));
		List<Invoker<String>> invokers = new ArrayList<Invoker<String>>();
		Invoker<String> invoker1 = new MockInvoker<String>(
				URL.valueOf("janus://10.20.3.3:20880/com.foo.BarService"));
