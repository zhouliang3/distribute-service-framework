 ...
 */
package com.ctg.itrdc.janus.rpc.cluster.configurator.override;
...
public class OverrideConfiguratorTest {
    ...
    public void testOverride_Application(){
        ...
        URL url = configurator.configure(URL.valueOf("janus://10.20.153.10:20880/com.foo.BarService?application=foo"));
        Assert.assertEquals("200", url.getParameter("timeout"));
        
        url = configurator.configure(URL.valueOf("janus://10.20.153.10:20880/com.foo.BarService?application=foo&timeout=1000"));
        Assert.assertEquals("200", url.getParameter("timeout"));
        
        url = configurator.configure(URL.valueOf("janus://10.20.153.11:20880/com.foo.BarService?application=bar"));
        Assert.assertNull(url.getParameter("timeout"));
        
        url = configurator.configure(URL.valueOf("janus://10.20.153.11:20880/com.foo.BarService?application=bar&timeout=1000"));
