...
public class ClusterUtilsTest {
    ...
    public void testMergeUrl() throws Exception {
        URL providerURL = URL.valueOf("janus://localhost:55555");
        providerURL = providerURL.setPath("path")
            .setUsername("username")
            .setPassword("password");

        providerURL = providerURL.addParameter(Constants.GROUP_KEY, "janus")
            .addParameter(Constants.VERSION_KEY, "1.2.3")
            .addParameter(Constants.JANUS_VERSION_KEY, "2.3.7")
        ...
        URL consumerURL = URL.valueOf("janus://localhost:55555");
