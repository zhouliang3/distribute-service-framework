...
public class HeaderExchangeClient implements ExchangeClient {
    ...
    private static final ScheduledThreadPoolExecutor scheduled = new ScheduledThreadPoolExecutor(2, new NamedThreadFactory("janus-remoting-client-heartbeat", true));
    ...
    public HeaderExchangeClient(Client client){
        ...
        String janus = client.getUrl().getParameter(Constants.JANUS_VERSION_KEY);
        this.heartbeat = client.getUrl().getParameter( Constants.HEARTBEAT_KEY, janus != null && janus.startsWith("1.0.") ? Constants.DEFAULT_HEARTBEAT : 0 );
