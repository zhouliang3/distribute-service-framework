...
import com.ctg.itrdc.janus.remoting.exchange.support.ReplierDispatcher;
...
public class Main
{
	...
	private static void startServer(int port) throws Exception
	{
		...
		Exchangers.bind(URL.valueOf("janus://localhost:" + port), dispatcher);
	}

	static void dataPackageTest(int port) throws Exception
	{
		ExchangeChannel client = Exchangers.connect(URL.valueOf("janus://localhost:" + port));
