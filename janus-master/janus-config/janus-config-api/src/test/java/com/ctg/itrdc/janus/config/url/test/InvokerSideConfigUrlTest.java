...
import com.ctg.itrdc.janus.config.support.MockRegistry;
...
//            {"generic", "generic", "boolean", false, true, "", "", "", "", ""},  
            ...
            //{"mock", "mock", "string", "false", "janus.test.HelloServiceMock", "true", "", "", "", ""},
...
//            {"", "", "", "", "", "", "", "", "", ""}, 
    ...
    private void initRefConf(){
        ...
        refConf.setInterface("com.ctg.itrdc.janus.config.api.DemoService");
