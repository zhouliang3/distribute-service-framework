 ...
 */
package com.ctg.itrdc.janus.config.url.test;
...
import com.ctg.itrdc.janus.config.RpcConfigGetSetProxy;
import com.ctg.itrdc.janus.config.ServiceConfig;
import com.ctg.itrdc.janus.config.api.DemoService;
import com.ctg.itrdc.janus.config.provider.impl.DemoServiceImpl;
...
public class UrlTestBase {
    ...
    protected Object servConfTable[][] = {
            ...
            {"document", "document", "string", "", "http://b2b-doc.alibaba-inc.com/display/RC/janus_devguide.htm?testquery=你好你好", "", "", "", "", ""},
