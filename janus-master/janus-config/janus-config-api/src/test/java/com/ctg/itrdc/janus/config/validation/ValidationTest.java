 ...
 */
package com.ctg.itrdc.janus.config.validation;
...
public class ValidationTest {
    ...
    public void testValidation() {
        ...
        service.setProtocol(new ProtocolConfig("janus", 29582));
        ...
        try {
            ...
            reference.setUrl("janus://127.0.0.1:29582?scope=remote&validation=true");
    ...
    public void testProviderValidation() {
        ...
        try {
            ...
            reference.setApplication(new ApplicationConfig("validation-consumer"));
            reference.setInterface(ValidationService.class);
            reference.setUrl("janus://127.0.0.1:29582");
            ValidationService validationService = reference.get();
            try {
                // Save OK
                ValidationParameter parameter = new ValidationParameter();
