...
import com.ctg.itrdc.janus.common.extensionloader.adaptive.impl.HasAdaptiveExt_ManualAdaptive;
...
import com.ctg.itrdc.janus.common.extensionloader.ext2.UrlHolder;
import com.ctg.itrdc.janus.common.extensionloader.ext3.UseProtocolKeyExt;
import com.ctg.itrdc.janus.common.extensionloader.ext4.NoUrlParamExt;
import com.ctg.itrdc.janus.common.extensionloader.ext5.NoAdaptiveMethodExt;
import com.ctg.itrdc.janus.common.extensionloader.ext6_inject.Ext6;
import com.ctg.itrdc.janus.common.extensionloader.ext6_inject.impl.Ext6Impl2;
...
public class ExtensionLoader_Adaptive_Test {
    ...
    public void test_getAdaptiveExtension_ExceptionWhenNoAdaptiveMethodOnInterface() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(), 
                    allOf(containsString("Can not create adaptive extenstion interface com.ctg.itrdc.janus.common.extensionloader.ext5.NoAdaptiveMethodExt"),
                            containsString("No adaptive method on extension com.ctg.itrdc.janus.common.extensionloader.ext5.NoAdaptiveMethodExt, refuse to create the adaptive class")));
        }
        // 多次get，都会报错且相同
        try {
            ExtensionLoader.getExtensionLoader(NoAdaptiveMethodExt.class).getAdaptiveExtension();
    ...
    public void test_getAdaptiveExtension_ExceptionWhenNotAdaptiveMethod() throws Exception {
        ...
        try {
            ...
            assertThat(
                    expected.getMessage(),
                    containsString("of interface com.ctg.itrdc.janus.common.extensionloader.ext1.SimpleExt is not adaptive method!"));
        }
    }
    ...
    public void test_urlHolder_getAdaptiveExtension_UrlNpe() throws Exception {
        ...
        try {
            ...
            assertEquals("com.ctg.itrdc.janus.common.extensionloader.ext2.UrlHolder argument == null", e.getMessage());
        }
        ...
        try {
            ...
            assertEquals("com.ctg.itrdc.janus.common.extensionloader.ext2.UrlHolder argument getUrl() == null", e.getMessage());
        }
    }
    ...
    public void test_urlHolder_getAdaptiveExtension_ExceptionWhenNotAdativeMethod() throws Exception {
        ...
        try {
            ...
            assertThat(
                    expected.getMessage(),
                    containsString("of interface com.ctg.itrdc.janus.common.extensionloader.ext2.Ext2 is not adaptive method!"));
        }
    }
    ...
    public void test_urlHolder_getAdaptiveExtension_ExceptionWhenNameNotProvided() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("Fail to get extension(com.ctg.itrdc.janus.common.extensionloader.ext2.Ext2) name from url"));
        }
    }
