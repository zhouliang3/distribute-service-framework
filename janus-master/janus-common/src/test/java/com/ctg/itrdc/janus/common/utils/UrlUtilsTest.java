 ...
 */
package com.ctg.itrdc.janus.common.utils;
...
public class UrlUtilsTest {
    ...
    public void testParseUrl() {
        String address = "remote://root:alibaba@127.0.0.1:9090/janus.test.api";
        ...
        assertEquals("janus.test.api", url.getPath());
    ...
    public void testParseFromParameter() {
        ...
        parameters.put("protocol", "janus");
        parameters.put("path", "janus.test.api");
    ...
    public void testConvertRegister() {
        String key = "perf/janus.test.api.HelloService:1.0.0";
    ...
    public void testConvertRegister2() {
        String key = "janus.test.api.HelloService";
        Map<String, Map<String, String>> register = new HashMap<String, Map<String, String>>();
        Map<String, String> service = new HashMap<String, String>();
        service.put("janus://127.0.0.1:20880/com.xxx.XxxService", "version=1.0.0&group=test&janus.version=2.0.0");
        register.put(key, service);
        Map<String, Map<String, String>> newRegister = UrlUtils.convertRegister(register);
        Map<String, String> newService = new HashMap<String, String>();
        newService.put("janus://127.0.0.1:20880/com.xxx.XxxService", "group=test&janus.version=2.0.0&version=1.0.0");
        assertEquals(newService, newRegister.get("test/janus.test.api.HelloService:1.0.0"));
    }
    ...
    public void testSubscribe2() {
        String key = "janus.test.api.HelloService";
        Map<String, String> subscribe = new HashMap<String, String>();
        subscribe.put(key, "version=1.0.0&group=test&janus.version=2.0.0");
        Map<String, String> newSubscribe = UrlUtils.convertSubscribe(subscribe);
        assertEquals("group=test&janus.version=2.0.0&version=1.0.0", newSubscribe.get("test/janus.test.api.HelloService:1.0.0"));
    }
    ...
    public void testRevertRegister() {
        ...
        Map<String, Map<String, String>> register = new HashMap<String, Map<String, String>>();
        Map<String, String> service = new HashMap<String, String>();
        service.put("janus://127.0.0.1:20880/com.xxx.XxxService", null);
        register.put(key, service);
        ...
        service.put("janus://127.0.0.1:20880/com.xxx.XxxService", "group=perf&version=1.0.0");
        expectedRegister.put("janus.test.api.HelloService", service);
    ...
    public void testRevertSubscribe() {
        ...
        expectSubscribe.put("janus.test.api.HelloService", "group=perf&version=1.0.0");
    ...
    public void testRevertNotify() {
        ...
        Map<String, Map<String, String>> expectedRegister = new HashMap<String, Map<String, String>>();
        service.put("janus://127.0.0.1:20880/com.xxx.XxxService", "group=perf&version=1.0.0");
        expectedRegister.put("perf/janus.test.api.HelloService:1.0.0", service);
        assertEquals(expectedRegister, newRegister);
    }
    ...
    public void testRevertForbid() {
        String service = "janus.test.api.HelloService";
        List<String> forbid = new ArrayList<String>();
        forbid.add(service);
        Set<URL> subscribed = new HashSet<URL>();
        subscribed.add(URL.valueOf("janus://127.0.0.1:20880/" + service + "?group=perf&version=1.0.0"));
    ...
    public void testRevertForbid3() {
        String service1 = "janus.test.api.HelloService:1.0.0";
        String service2 = "janus.test.api.HelloService:2.0.0";
        List<String> forbid = new ArrayList<String>();
        forbid.add(service1);
        forbid.add(service2);
    ...
    public void testIsMatch() {
        URL consumerUrl = URL.valueOf("janus://127.0.0.1:20880/com.xxx.XxxService?version=1.0.0&group=test");
    ...
    public void testIsMatch2() {
        URL consumerUrl = URL.valueOf("janus://127.0.0.1:20880/com.xxx.XxxService?version=2.0.0&group=test");
        URL providerUrl = URL.valueOf("http://127.0.0.1:8080/com.xxx.XxxService?version=1.0.0&group=test");
    ...
    public void testIsMatch3() {
        URL consumerUrl = URL.valueOf("janus://127.0.0.1:20880/com.xxx.XxxService?version=1.0.0&group=aa");
        URL providerUrl = URL.valueOf("http://127.0.0.1:8080/com.xxx.XxxService?version=1.0.0&group=test");
        assertFalse(UrlUtils.isMatch(consumerUrl, providerUrl));
    }
    ...
    public void testIsMatch4() {
        URL consumerUrl = URL.valueOf("janus://127.0.0.1:20880/com.xxx.XxxService?version=1.0.0&group=*");
        URL providerUrl = URL.valueOf("http://127.0.0.1:8080/com.xxx.XxxService?version=1.0.0&group=test");
        assertTrue(UrlUtils.isMatch(consumerUrl, providerUrl));
    }
    ...
    public void testIsMatch5() {
        URL consumerUrl = URL.valueOf("janus://127.0.0.1:20880/com.xxx.XxxService?version=*&group=test");
        URL providerUrl = URL.valueOf("http://127.0.0.1:8080/com.xxx.XxxService?version=1.0.0&group=test");
        assertTrue(UrlUtils.isMatch(consumerUrl, providerUrl));
    }
