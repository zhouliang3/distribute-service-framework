...
import com.ctg.itrdc.janus.common.serialize.support.janus.JanusSerialization;

/**
 * @author ding.lid
 *
 */
public class JanusSerializationTest extends AbstractSerializationPersionFailTest {
    {
        serialization = new JanusSerialization();
    }
    
    /**
     * @desc:JanusSerialization error: java.lang.IllegalAccessError: tried to access class java.util.Arrays$ArrayList from class com.ctg.itrdc.janus.common.serialize.support.janus.Builder$bc6
