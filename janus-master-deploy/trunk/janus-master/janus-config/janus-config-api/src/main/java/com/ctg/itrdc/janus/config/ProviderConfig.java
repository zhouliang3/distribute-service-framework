...
/**
 * 提供者协议缺省值，当协议属性未设置时使用该缺省值替代
 * 
 * @see com.ctg.itrdc.janus.config.ProtocolConfig
 * @see com.ctg.itrdc.janus.config.ServiceConfig
 *
 * @export
 */
public class ProviderConfig extends AbstractServiceConfig {
	...
	public void setProtocol(String protocol) {
		this.protocols = Arrays
				.asList(new ProtocolConfig[] { new ProtocolConfig(protocol) });
	}
