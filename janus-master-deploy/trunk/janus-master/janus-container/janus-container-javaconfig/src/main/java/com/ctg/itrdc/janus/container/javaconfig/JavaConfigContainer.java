 ...
 */
package com.ctg.itrdc.janus.container.javaconfig;
...
public class JavaConfigContainer implements Container {
    ...
    public static final String SPRING_JAVACONFIG = "janus.spring.javaconfig";

    public static final String DEFAULT_SPRING_JAVACONFIG = "janus.spring.javaconfig";
