...
class CallbackServiceCodec {
    ...
    private static final JanusProtocol protocol = JanusProtocol.getJanusProtocol();
    ...
    private static String exportOrunexportCallbackService(Channel channel, URL url, Class clazz, Object inst, Boolean export) throws IOException{
        ...
        //增加方法，变于方法检查，自动降级(见janus protocol)
        ...
        URL exporturl = new URL(JanusProtocol.NAME, channel.getLocalAddress().getAddress().getHostAddress(), channel.getLocalAddress().getPort(), clazz.getName()+"."+instid, tmpmap);
    ...
    public static Object decodeInvocationArgument(Channel channel, RpcInvocation inv, Class<?>[] pts, int paraIndex, Object inObject) throws IOException{
        ...
        URL url = null ;
        try {
            url = JanusProtocol.getJanusProtocol().getInvoker(channel, inv).getUrl();
