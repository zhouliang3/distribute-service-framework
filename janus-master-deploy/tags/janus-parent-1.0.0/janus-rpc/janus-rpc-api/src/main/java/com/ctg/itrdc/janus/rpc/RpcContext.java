 ...
 * 
 * @see com.ctg.itrdc.janus.rpc.filter.ContextFilter
...
public class RpcContext {
	 ...
	 * HttpServletRequest
	 *
	 * @return null if the underlying protocol doesn't provide support for
	 *         getting request
	 */
	 ...
	 *
	 * @return null if the underlying protocol doesn't provide support for
	 *         getting request or the request is not of the specified type
	 */
	@SuppressWarnings("unchecked")
	public <T> T getRequest(Class<T> clazz) {
		return (request != null && clazz.isAssignableFrom(request.getClass())) ? (T) request
				: null;
	}
	 ...
	 *
	 * @return null if the underlying protocol doesn't provide support for
	 *         getting response or the response is not of the specified type
	 */
	@SuppressWarnings("unchecked")
	public <T> T getResponse(Class<T> clazz) {
		return (response != null && clazz.isAssignableFrom(response.getClass())) ? (T) response
				: null;
	}
