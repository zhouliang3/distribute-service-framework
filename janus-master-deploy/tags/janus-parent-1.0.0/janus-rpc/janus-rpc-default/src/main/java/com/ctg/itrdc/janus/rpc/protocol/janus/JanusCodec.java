...
import com.ctg.itrdc.janus.common.io.Bytes;
...
import com.ctg.itrdc.janus.common.serialize.OptimizedSerialization;
...
import com.ctg.itrdc.janus.remoting.exchange.codec.ExchangeCodec;
...
import static com.ctg.itrdc.janus.rpc.protocol.janus.CallbackServiceCodec.encodeInvocationArgument;
 ...
 * @author chao.liuc
 */
public class JanusCodec extends ExchangeCodec implements Codec2 {

    private static final Logger log = LoggerFactory.getLogger(JanusCodec.class);

    public static final String NAME = "janus";

    public static final String JANUS_VERSION = Version.getVersion(JanusCodec.class, Version.getVersion());
    ...
    protected void encodeRequestData(Channel channel, ObjectOutput out, Object data) throws IOException {
        ...
        out.writeUTF(inv.getAttachment(Constants.JANUS_VERSION_KEY, JANUS_VERSION));
