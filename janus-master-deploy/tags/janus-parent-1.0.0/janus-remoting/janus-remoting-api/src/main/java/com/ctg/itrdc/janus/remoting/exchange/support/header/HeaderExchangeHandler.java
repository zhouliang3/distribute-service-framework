...
import com.ctg.itrdc.janus.remoting.exchange.support.DefaultFuture;
        ...
        try {
            if (message instanceof Request) {
                ...
                if (isClientSide(channel)) {
                    Exception e = new Exception("Janus client can not supported string message: " + message + " in channel: " + channel + ", url: " + channel.getUrl());
